...
public extension Date {
    ...
    func toStringTimeZone(format: DateFormatType, timeZone: TimeZone, locale: Locale = Locale.current) -> String {
        switch format {
        case .dotNet:
            let offset = Foundation.NSTimeZone.default.secondsFromGMT() / 3600
            let nowMillis = 1000 * self.timeIntervalSince1970
        ...
        let formatter = Date.cachedFormatter(format.stringFormat, timeZone: timeZone, locale: locale)
        return formatter.string(from: self)
    }
...
public enum DateFormatType {
    ...
    var stringFormat:String {
        ...
        case .isoDateTimeSec: return "yyyy-MM-dd'T'HH:mm:ss"
